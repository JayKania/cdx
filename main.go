...
func clearScreen() {
	fmt.Print("\033[3J\033[H\033[2J") // ANSI escape code to clear screen + scrollback and move cursor to top-left
}
...
func buildOptions() []string {
	...
	// separating directories and files as there might os.ReadDir(".") does not maintain the order 
	dirOptions := []string{}
	fileOptions := []string{}
